...
首先，这篇笔记是我边学习边写的，刚开始学习算法时，并没有按照书本的顺序进行学习，而是根据[Python100 days](https://github.com/jackfrued/Python-100-Days)的步骤进行学习打的。后来发现需要更加系统的学习算法随在学习《Python数据结构与算法分析》和《算法图解》的同时，进行笔记记录，当然这个学习笔记是按照数据结构的顺序进行的。

_注：后面笔者逐渐适应了纯英语的工作环境，随，语言已经改为ENG了..._
...
U should notice that the `adjacency list` has its direction:
>
