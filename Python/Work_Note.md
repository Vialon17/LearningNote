...
The second way seems is not a good way because of its security policy, it accepts all requests from any domains and may cause some questions, this should only be used for wide area website.
...
___must add request protocol header!!!___
